# "Kreepyrights (GNU GPL) <2022> <Taiseibutsu>" Tested in Blender 3.2
...
class tb_colection_selector_viewer(bpy.types.Operator):
    """Operator which exclude all the non selected collections"""
    bl_idname = "wm.tb_collection_selection"
...
def menu_func(self, context):
    self.layout.operator(tb_colection_selector_viewer.bl_idname, text=tb_colection_selector_viewer.bl_label)
    
def TB_OUTLINER_UI_HEADER(self, context):
    layout = self.layout
